...
from .ui.pie_menus import (
    ...
    LUMI_MT_template_studio_commercial_apparel,
    LUMI_MT_template_studio_commercial_automotive,
    LUMI_MT_template_studio_commercial_cosmetics,
    LUMI_MT_template_studio_commercial_electronics,
    LUMI_MT_template_studio_commercial_food,
    LUMI_MT_template_studio_commercial_furniture,
    LUMI_MT_template_studio_commercial_jewelry,
